...
左ペインは薄い作成バー（Dock.Top）+ ツリー。バーは 12 DIP DualFont、本文 fontSize 非連動、ラベル「ファイル」「フォルダ」、余白 6 DIP・間隔 4 DIP、上下 4 DIP、下端 1 物理 px Theme.Border、ChromeMark（ホバー CurrentLine、枠 Border）。新しい Theme 色は足さない。名前ダイアログも 12 DIP DualFontField（editor/@fontSize ではない）。
