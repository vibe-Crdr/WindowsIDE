...
編集・実行・デバッグの対象は C# 5、VBA、Windows PowerShell 5.1、cmd。VBA はフォルダで管理し、Excel（Microsoft 365 64-bit）と同期する。Excel 側の VBA は平坦なまま。
...
| コンパイラ | `C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe`（C# 5） |
